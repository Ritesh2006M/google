  ...
  return (
     <aside className="fixed top-0 left-0 z-50 w-72 h-screen flex flex-col justify-between bg-white/80 dark:bg-[#1A1A1A]/80 backdrop-blur-md border-r border-gray-300/50 dark:border-gray-800/50 shadow-lg p-6">
      ...
      <div className="space-y-3 pt-6">
        ...
        <button
          onClick={toggleTheme}
          className="flex items-center justify-center gap-2 px-4 py-2 text-sm w-full font-medium text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-xl transition-all"
        >
